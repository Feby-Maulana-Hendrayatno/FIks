...
@section('title', 'Spesialisasi Kami')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{ url('/admin/spesialisasi_kami/add_spesialisasi') }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($data_spesialisasi_kami as $data)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('/admin/spesialisasi_kami/' . encrypt($data->id) . '/edit') }}"
        ...
        $(document).ready(function() {
            $('body').on('click', '#deleteSpesialisasiKami', function() {
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete spesialisasi kami'
                }).then((result) => {
                    if (result.isConfirmed) {
                        form_string =
                            "<form method=\"POST\" action=\"{{ url('/admin/spesialisasi_kami/') }}/" +
                            id +
